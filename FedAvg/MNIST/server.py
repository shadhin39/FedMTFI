...
def plot_accuracies():
    ...
    plt.title("Global Model Evaluation Accuracies for Centralized FL (Student) Over Rounds on MNIST Dataset", fontsize=16, fontweight='bold')
...
def plot_losses():
    ...
    plt.title("Global Model Evaluation Losses for Centralized FL (Student) Over Rounds on MNIST", fontsize=16, fontweight='bold')
    plt.xlabel("Federated Learning Round", fontsize=14)
...
output_path = "Global Model Evaluation Accuracies and Losses for Centralized FL (Student) Over Rounds on MNIST.csv"
