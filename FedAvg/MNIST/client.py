...
def plot_training_accuracy():
    if train_accuracies:
        ...
        plt.title(f'Centralized FL (Student): MNIST Dataset, Training Accuracy of Client {client_id} Over Rounds', fontsize=16)
...
output_path = "Centralized FL (Student) MNIST Dataset, Training Accuracy of Client 0 Over Rounds.csv"
